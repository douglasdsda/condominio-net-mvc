...
namespace GerenciadorCondominios.Controllers
{
      ...
      if (ModelState.IsValid)
            {
                if (foto != null)
                {
                    ...
                    {
                        await foto.CopyToAsync(fileStream);
                        viewModel.Foto = "~/Images/" + nomeFoto;
                    }
                }
                ...
                usuario.Foto = viewModel.Foto == null ? usuario.Foto : viewModel.Foto;
    ...
    [Authorize]
    [HttpPost]
    public async Task<IActionResult> RedefinirSenha(LoginViewModels model){
